...
#include "../state/lapi.h"
#include "../debug/ldebug.h"
#include "ldo.h"
#include "../objects/lfunc.h"
#include "../memory/lgc.h"
#include "../memory/lmem.h"
#include "../objects/lobject.h"
#include "../../parser/lopcodes.h"
#include "../../parser/lparser.h"
#include "../state/lstate.h"
#include "../../lib/lstring.h"
#include "../../lib/ltable.h"
#include "../objects/ltm.h"
#include "../io/lundump.h"
#include "lvm.h"
#include "../io/lzio.h"
...
** maximum top of all call style in the stack and the current top.
*/
...
** (so that it include the function itself). Return the number of
